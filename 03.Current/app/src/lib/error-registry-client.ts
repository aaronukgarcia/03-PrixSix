...
export const CLIENT_ERRORS = {
  ...
  INVITE_SEND_FAILED:             { key: 'INVITE_SEND_FAILED',             code: 'PX-2101', message: 'Invite could not be sent',                                                 severity: 'error'    },
  INVITE_INVALID:                 { key: 'INVITE_INVALID',                 code: 'PX-2102', message: 'Invite link is invalid or has already been used',                          severity: 'warning'  },
  INVITE_EXPIRED:                 { key: 'INVITE_EXPIRED',                 code: 'PX-2103', message: 'Invite link has expired',                                                  severity: 'warning'  },
  INVITE_ALREADY_MEMBER:          { key: 'INVITE_ALREADY_MEMBER',          code: 'PX-2104', message: 'This email already belongs to a Prix Six player',                          severity: 'warning'  },
