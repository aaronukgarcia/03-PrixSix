// GUID: LIB_ATTACK_DETECTION-000-v03
...
// GUID: LIB_ATTACK_DETECTION-001-v03
...
// GUID: LIB_ATTACK_DETECTION-002-v03
...
// GUID: LIB_ATTACK_DETECTION-003-v03
...
// GUID: LIB_ATTACK_DETECTION-004-v03
...
// GUID: LIB_ATTACK_DETECTION-005-v03
...
// GUID: LIB_ATTACK_DETECTION-006-v03
...
// GUID: LIB_ATTACK_DETECTION-007-v03
// [Intent] Detects bot attacks by counting failed login attempts from a single IP within the configured time window (10+ in 5 minutes).
...
// GUID: LIB_ATTACK_DETECTION-008-v03
// [Intent] Detects credential stuffing by counting unique email addresses targeted from a single IP within the configured time window (5+ accounts in 5 minutes).
// [Inbound Trigger] Called by checkForAttack when evaluating the current IP address after a failed login.
...
// GUID: LIB_ATTACK_DETECTION-009-v03
// [Intent] Detects distributed attacks by counting unique IPs targeting a single email with sufficient failures within the configured time window (5+ IPs and 8+ failures in 10 minutes).
...
// GUID: LIB_ATTACK_DETECTION-010-v03
