...
export const ERRORS: Record<string, ErrorDefinition> = {
  ...
  // GUID: PIT_WALL_ERRORS-001-v01
  PIT_WALL_FETCH_FAILED: {
    key: 'PIT_WALL_FETCH_FAILED',
    code: 'PX-3301',
    message: 'Pit Wall live data fetch failed',
    severity: 'error' as const,
    description: 'One or more OpenF1 endpoints failed during the Pit Wall live-data fan-out.',
    suggestedAction: 'Retry. If persistent, OpenF1 may be unavailable.',
    modulePath: 'app/src/app/api/pit-wall/live-data/route.ts',
  },
  // GUID: PIT_WALL_ERRORS-002-v01
  PIT_WALL_NO_SESSION: {
    key: 'PIT_WALL_NO_SESSION',
    code: 'PX-3302',
    message: 'No active F1 session found',
    severity: 'warning' as const,
    description: 'OpenF1 session_key=latest returned no active session.',
    suggestedAction: 'Pit Wall is only available during live F1 sessions.',
    modulePath: 'app/src/app/api/pit-wall/live-data/route.ts',
  },
  // GUID: PIT_WALL_ERRORS-003-v01
  PIT_WALL_PARTIAL_DATA: {
    key: 'PIT_WALL_PARTIAL_DATA',
    code: 'PX-3303',
    message: 'Some Pit Wall data could not be loaded',
    severity: 'warning' as const,
    description: 'The live-data fan-out partially failed — some endpoints returned data, others did not.',
    suggestedAction: 'Partial data is shown. Retry for complete data.',
    modulePath: 'app/src/app/api/pit-wall/live-data/route.ts',
  },
  // GUID: PIT_WALL_ERRORS-004-v01
  PIT_WALL_RADIO_UNAVAIL: {
    key: 'PIT_WALL_RADIO_UNAVAIL',
    code: 'PX-3304',
    message: 'Team radio data unavailable for this session',
    severity: 'info' as const,
    description: 'OpenF1 team_radio endpoint returned no data for this session.',
    suggestedAction: 'Radio clips may not be available for all session types.',
    modulePath: 'app/src/app/api/pit-wall/live-data/route.ts',
  },
  // GUID: PIT_WALL_ERRORS-005-v01
  PIT_WALL_RAIN_FETCH_FAILED: {
    key: 'PIT_WALL_RAIN_FETCH_FAILED',
    code: 'PX-3305',
    message: 'Weather radar data could not be loaded',
    severity: 'info' as const,
    description: 'RainViewer API manifest fetch failed. Rain overlay will be unavailable.',
  ...
  STANDINGS_HEALTH_DEGRADED: {
    ...
    calledBy: ['API_ADMIN_HEALTH_STANDINGS-000'],
    calls: [],
  },
  STANDINGS_FETCH_FAILED: {
    ...
    calledBy: ['PAGE_STANDINGS-011'],
    calls: ['API_STANDINGS-000'],
  },
  SESSION_INVALID: {
    key: 'SESSION_INVALID',
    code: 'PX-6001',
