...
const ChartTooltipContent = React.forwardRef<
  ...
  Omit<React.ComponentProps<typeof RechartsPrimitive.Tooltip>, "content"> &
    React.ComponentProps<"div"> & {
      ...
      nameKey?: string
      labelKey?: string
      // recharts v3: payload and label are injected at runtime via content prop
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    hideIcon?: boolean
    nameKey?: string
    // recharts v3: LegendProps omits payload and verticalAlign; use DefaultLegendContentProps for these
